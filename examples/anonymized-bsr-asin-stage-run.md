...
This example shows how the agent should behave when the user already has BSR, keyword, and competitor ASIN evidence. The correct behavior is to route into QYPM Round 1 and prepare QYPM 004, while still avoiding final product definition or ROI.
...
Goal: decide which QYPM stage can run now and what the output should be.
```

## Expected Routing

`QYPM Round 1: 001-003, preparing 004`
...
The available evidence is enough to run QYPM Round 1: 001 company fit, 002 trend/demand reading, and 003 market structure. Because 25 competitor ASINs are available, the workflow can also prepare QYPM 004 competitor segmentation. It is not yet ready for final product definition, ROI, or sourcing decisions.

## Current Stage

QYPM 001-003, with QYPM 004 preparation.
...
| P1 | Review/VOC sample | Identify real dissatisfaction | Run QYPM 005 after ASIN pool is cleaned |
...
3. Select 8-12 direct competitors for QYPM 004.
4. Move to QYPM 005 only after Review/Q&A evidence is collected.
